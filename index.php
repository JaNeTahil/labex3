...
<body>
    ...
    <article>
        ...
        <p class="marginbot50">Standard form for <b>online registration</b> on a website:</p>

        <form action="#second-section" method="POST" enctype="multipart/form-data" class="form-element" name="form">
            <div>
                <label for="gender">Enter your <b>Gender</b>: <span class="mandatory">*</span></label>
                <label>
            ...
            <div>
                <label> your <b>Firstname</b>:</label>
            ...
            <div>
                <label for="img">Enter your <b>Photo</b>:</label>
                <input type="file" name="imageFile" id="img" class="toBeMargin" >
            </div>
            <div>
                <label for="email">Enter your <b>Email Address</b>:<span class="mandatory">*</span></label>
                <input type="email" name="email" id="email" class="toBeMargin">
            </div>
            <div>
                <label for="pass">Enter your <b>Password</b>:<span class="mandatory">*</span></label>
                <input type="password" name="pword" id="pword" class="toBeMargin">
            </div>
            <div>
                <label for="confirmpwd">Confirm your <b>Password</b>:<span class="mandatory">*</span></label>
        ...
        <section class="third" id="third-section">
            ...
            <article>
                <h2>Contact Form</h2>
                <p class="marginbot50">Standard form for making <b>information request</b> credentials:</p>
                ...
                <form action="#third-section" method="POST" name="form" class="form-element">
                  ...
                  <div>
                      <label for="title">Enter a <b>title</b>: <span class="mandatory">*</span></label>
                      <input type="text" name="title" id="title" placeholder="More than 20 characters">
                  </div>

                  <div>
                      <label for="question">Enter your <b>Question</b>:<span class="mandatory">*</span></label>
                      <textarea id="myTextarea" name="textarea" placeholder="Enter your text here..."></textarea>
                  </div>

                  <div>
                      <label for="password">Enter your <b>Email Address</b>:<span class="mandatory">*</span> </label>
